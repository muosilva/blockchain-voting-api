...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../common.js"
  ...
  export interface StakeTokenInterface extends Interface {
    getFunction(nameOrSignature: "approve" | "balanceOf" | "batchMint" | "getApproved" | "isApprovedForAll" | "mint" | "name" | "nextTokenId" | "owner" | "ownerOf" | "renounceOwnership" | "safeTransferFrom(address,address,uint256)" | "safeTransferFrom(address,address,uint256,bytes)" | "setApprovalForAll" | "setBaseTokenURI" | "supportsInterface" | "symbol" | "tokenByIndex" | "tokenOfOwnerByIndex" | "tokenURI" | "tokensOfOwner" | "totalSupply" | "transferFrom" | "transferOwnership"): FunctionFragment;

    getEvent(nameOrSignatureOrTopic: "Approval" | "ApprovalForAll" | "BaseTokenURIUpdated" | "OwnershipTransferred" | "Transfer"): EventFragment;

    encodeFunctionData(functionFragment: 'approve', values: [AddressLike, BigNumberish]): string;
encodeFunctionData(functionFragment: 'balanceOf', values: [AddressLike]): string;
encodeFunctionData(functionFragment: 'batchMint', values: [AddressLike[]]): string;
...
getEvent(key: 'BaseTokenURIUpdated'): TypedContractEvent<BaseTokenURIUpdatedEvent.InputTuple, BaseTokenURIUpdatedEvent.OutputTuple, BaseTokenURIUpdatedEvent.OutputObject>;
...
getEvent(key: 'Transfer'): TypedContractEvent<TransferEvent.InputTuple, TransferEvent.OutputTuple, TransferEvent.OutputObject>;
    ...
    filters: {
      ...
      'BaseTokenURIUpdated(string)': TypedContractEvent<BaseTokenURIUpdatedEvent.InputTuple, BaseTokenURIUpdatedEvent.OutputTuple, BaseTokenURIUpdatedEvent.OutputObject>;
      BaseTokenURIUpdated: TypedContractEvent<BaseTokenURIUpdatedEvent.InputTuple, BaseTokenURIUpdatedEvent.OutputTuple, BaseTokenURIUpdatedEvent.OutputObject>;
